var Haiku = React.createClass({
  ...
  socShare: function (socialMedia, text) {
    var socialMediaUrl;
    if (!text) {
      text = "In%20this%20interactive%20haiku%20by%20%40cosmografik,%20discover%20a%20poetic%20and%20tactile%20stroll%20through%20the%20four%20seasons";
    }
    switch (socialMedia) {
    case 'facebook':
      if (!text) {
        ...
        FB.ui({
          method: 'feed',
          name: "Der Wanderer der Jahreszeiten – Interaktive Haikus – ONF und ARTE",
          link: "http://interactivehaiku.com/seasonalstroller",
          picture: "http://interactivehaiku.com/seasonalstroller/assets/post_facebook.jpg",
          caption: window.location.href,
      ...
      break;
    case 'twitter':
      socialMediaUrl = "http://twitter.com/intent/tweet?url=interactivehaiku.com/seasonalstroller;text=" + text + ";hashtags=InteractiveHaikus";
      break;
    case 'pinterest':
