var Haiku = React.createClass({
  ...
  socShare: function (socialMedia, text) {
    var socialMediaUrl;
    if (!text) {
      "einen%20poetischen%20Spaziergang%20f%C3%BCr%20Touchscreens%20durch%20die%20vier%20Jahreszeiten%20dieses%20interaktiven%20Haikus%20von%20%40cosmografik";
    }
    switch (socialMedia) {
    case 'facebook':
      if (!text) {
        FB.ui({
          method: 'feed',
          name: "The seasonal stroller",
          link: "http://interactivehaiku.com/seasonalstroller",
          picture: "http://interactivehaiku.com/seasonalstroller/assets/post_facebook.jpg",
        ...
        FB.ui({
          method: 'feed',
          name: "The Seasonal Stroller – Interactive Haiku – NFB and ARTE",
          link: "http://interactivehaiku.com/seasonalstroller",
          picture: "http://interactivehaiku.com/seasonalstroller/assets/post_facebook.jpg",
          caption: window.location.href,
      ...
      break;
    case 'twitter':
      socialMediaUrl = "http://twitter.com/intent/tweet?url=interaktivehaikus.com/wandererderjahreszeiten;text=" + text + ";hashtags=InteraktiveHaikus";
      break;
    case 'pinterest':
